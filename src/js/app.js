(function() {
	...
	var globeConfigs = {
		miranda: {
			...
			radius: radius,
			segments: segments,
			map: '/images/Miranda_Map_Working_Wraparound_Composite_8000px.jpg',
			bumpMap:
				'/images/Miranda_Map_Working_Wraparound_Composite_8000px_bump.gif',
		...
		coronelli1: {
			...
			radius: radius,
			segments: segments,
			map: '/images/10070028-Coronelli-David-Rumsey-8000px.jpg',
			bumpMap: '/images/10070028-Coronelli-David-Rumsey-8000px-bump.gif',
			bumpScale: 0.0002,
